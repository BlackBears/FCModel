#
#  Be sure to run `pod spec lint fcmodel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Alan K. Duncan" => "alan@cocoa-factory.com", "other author" => "email@address.com" }
  # s.author       = 'Alan K. Duncan', 'other author'
  ...
  s.source       = { :git => "https://github.com/cocoa-factory/FCModel", :tag => "0.0.1" }
